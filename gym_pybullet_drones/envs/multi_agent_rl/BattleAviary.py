...
class BattleAviary(BaseMultiagentAviary):
    ...
    def __init__(self,
        ...
        self.previous_done = {0: False, 1: False}
    ...
    def _drone_shoot(self, drone_index):
        ...
        p.resetBaseVelocity(temp, [20, 0, 0], [0, 0, 0], physicsClientId=self.CLIENT)
    ...
    def _computeDone(self):
        ...
        # print("nume_drone" + str(self.NUM_DRONES))
        if self.step_counter > 3000:
            self.previous_done[0] = True
            print("DONEEEEE111111111111111111111111111111111111111111111111111111111111111111111111111111111")
            done[0] = True
        if self.step_counter > 5000:
            print("DONEEEEE1222222222222222222222222222222222222222222222222222222222222222222222222222222")
            done[1] = True
            self.previous_done[1] = True
            done["__all__"] = True
        return done
